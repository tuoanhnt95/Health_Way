...
class HealthCheckNotification < Noticed::Base
  ...
  #
  def message
    "#{params[:health_check].user.first_name.capitalize} #{params[:health_check].user.last_name.capitalize} made a health check appointment"
  end
  #
  # def url
