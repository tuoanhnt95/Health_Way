class SetUpsController < ApplicationController
  ...
  def show
    ...
    @complete_health_checks = health_checks.joins(:user).joins(:result_attachment)
    ...
    @no_result_checks = health_checks.joins(:user).where.not(id: @complete_health_checks).order(date: :asc)
  end
